    ...
    salvareUtilizator() {
        ...
        AccesBD.getInstanta(Utilizator.tipConexiune).insert({
            ...
            if (err)
                ...
                utiliz.trimiteMail("Bună, " + utiliz.username, "Bine ai venit în comunitatea Racebox",
                    `<h1>Bună, ${utiliz.username}!</h1><p><span style='font-size:25px; background:lightblue;'>Bine ai venit</span>  în comunitatea Racebox's shop!</p> <p><a href='http://${Utilizator.numeDomeniu}/cod/${utiliz.username}/${token}'>Click aici pentru confirmare</a></p>`,
                )
            }
        });
    }
